...
function registerAddIn(manifestPath, registration) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (manifest.manifestType === office_addin_manifest_1.ManifestType.JSON || appsInManifest.indexOf(office_addin_manifest_1.OfficeApp.Outlook) >= 0) {
            if (!registration) {
                let filePath = "";
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (manifest != undefined) {
            ...
            if (registration != undefined) {
                (0, publish_1.uninstallWithTeams)(registration);
