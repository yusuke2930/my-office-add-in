...
class ZipFileError extends teamsfx_api_1.UserError {
    constructor(error) {
        super({
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.ZipFileError"),
            displayMessage: localizeUtils_1.getLocalizedString("error.deploy.ZipFileError"),
            error: error,
            categories: [types_1.ErrorCategory.External],
        });
    }
...
class CacheFileInUse extends teamsfx_api_1.UserError {
    constructor(path, error) {
        super({
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.ZipFileTargetInUse", path),
            displayMessage: localizeUtils_1.getLocalizedString("error.deploy.ZipFileTargetInUse", path),
            error: error,
            categories: [types_1.ErrorCategory.External],
        });
    }
...
class GetPublishingCredentialsError extends teamsfx_api_1.UserError {
    constructor(appName, resourceGroup, error, helpLink) {
        super({
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.GetPublishingCredentialsError", appName, resourceGroup, stringifyError(error), "https://learn.microsoft.com/en-us/rest/api/appservice/web-apps/list-publishing-credentials#code-try-0"),
...
class DeployZipPackageError extends teamsfx_api_1.UserError {
    constructor(endpoint, error, helpLink) {
        var _a;
        super({
            name: `DeployZipPackageError${(_a = error.name) !== null && _a !== void 0 ? _a : ""}`,
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.DeployZipPackageError", endpoint, stringifyError(error), "https://learn.microsoft.com/azure/app-service/deploy-zip?tabs=cli"),
...
class CheckDeploymentStatusError extends teamsfx_api_1.UserError {
    constructor(location, error, helpLink, displayMessage) {
        super({
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.CheckDeploymentStatusError", location, stringifyError(error)),
...
class AzureStorageGetContainerError extends teamsfx_api_1.UserError {
    constructor(storageName, containerName, error, helpLink) {
        super({
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.AzureStorageGetContainerError", containerName, storageName, stringifyError(error)),
...
class AzureStorageGetContainerPropertiesError extends teamsfx_api_1.UserError {
    constructor(storageName, containerName, error, helpLink) {
        super({
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.AzureStorageGetContainerPropertiesError", containerName, storageName, stringifyError(error)),
...
class AzureStorageSetContainerPropertiesError extends teamsfx_api_1.UserError {
    constructor(storageName, containerName, error, helpLink) {
        super({
            source: "azureDeploy",
            message: localizeUtils_1.getDefaultString("error.deploy.AzureStorageSetContainerPropertiesError", containerName, storageName, stringifyError(error)),
...
function stringifyError(error) {
    ...
    try {
        ...
        return `${error.toString()} stack: ${(_a = error.stack) !== null && _a !== void 0 ? _a : ""}`;
    }
}
