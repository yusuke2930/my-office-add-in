...
AppStudioError.TeamsAppRequiredPropertyMissingError = {
    name: "TeamsAppMissingRequiredCapability",
    message: (property, path) => [
        localizeUtils_1.getDefaultString("error.appstudio.teamsAppRequiredPropertyMissing", property, path),
        localizeUtils_1.getLocalizedString("error.appstudio.teamsAppRequiredPropertyMissing", property, path),
    ],
};
