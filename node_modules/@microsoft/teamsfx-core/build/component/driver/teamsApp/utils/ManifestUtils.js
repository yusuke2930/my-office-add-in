...
class ManifestUtils {
    ...
    getCapabilities(template) {
        return projectTypeChecker_1.getCapabilities(template);
    }
    /**
    ...
    async getPluginFilePath(manifest, manifestPath) {
        var _a, _b, _c;
        const pluginFile = (_c = (_b = (_a = manifest.copilotExtensions) === null || _a === void 0 ? void 0 : _a.plugins) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.file;
        if (pluginFile) {
            ...
            if (doesFileExist) {
                return teamsfx_api_1.ok(plugin);
            }
            else {
                return teamsfx_api_1.err(new common_1.FileNotFoundError("ManifestUtils", pluginFile));
            }
        }
        else {
            return teamsfx_api_1.err(results_1.AppStudioResultFactory.UserError(errors_1.AppStudioError.TeamsAppRequiredPropertyMissingError.name, errors_1.AppStudioError.TeamsAppRequiredPropertyMissingError.message("plugins", manifestPath)));
        }
    }
    async getManifestV3(manifestTemplatePath, context, generateIdIfNotResolved = true) {
        ...
        const resolvedManifestRes = utils_1.getResolvedManifest(manifestTemplateString, manifestTemplatePath, telemetry_1.TelemetryPropertyKey.customizedKeys, context);
