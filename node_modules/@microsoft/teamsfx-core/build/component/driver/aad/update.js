...
let UpdateAadAppDriver = class UpdateAadAppDriver {
    constructor() {
        ...
        this.progressTitle = localizeUtils_1.getLocalizedString("driver.aadApp.progressBar.updateAadAppTitle");
    }
    async execute(args, context) {
        ...
        try {
            ...
            return {
                result: teamsfx_api_1.err(common_1.assembleError(error, exports.actionName)),
                summaries: summaries,
            };
        }
        finally {
