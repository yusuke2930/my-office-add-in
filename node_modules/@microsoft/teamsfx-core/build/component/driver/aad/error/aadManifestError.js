...
class MissingResourceAppIdUserError extends teamsfx_api_1.UserError {
    constructor(actionName) {
        super({
            ...
            message: localizeUtils_1.getDefaultString("error.aad.manifest.ResourceAppIdIsMissing"),
            displayMessage: localizeUtils_1.getLocalizedString("error.aad.manifest.ResourceAppIdIsMissing"),
            helpLink: "https://aka.ms/teamsfx-aad-manifest",
        });
    }
}
...
class MissingResourceAccessIdUserError extends teamsfx_api_1.UserError {
    constructor(actionName) {
        super({
            ...
            message: localizeUtils_1.getDefaultString("error.aad.manifest.ResourceAccessIdIsMissing"),
            displayMessage: localizeUtils_1.getLocalizedString("error.aad.manifest.ResourceAccessIdIsMissing"),
            helpLink: "https://aka.ms/teamsfx-aad-manifest",
        });
    }
}
...
class ResourceAccessShouldBeArrayUserError extends teamsfx_api_1.UserError {
    constructor(actionName) {
        super({
            ...
            message: localizeUtils_1.getDefaultString("error.aad.manifest.ResourceAccessShouldBeArray"),
            displayMessage: localizeUtils_1.getLocalizedString("error.aad.manifest.ResourceAccessShouldBeArray"),
            helpLink: "https://aka.ms/teamsfx-aad-manifest",
        });
    }
}
...
class RequiredResourceAccessShouldBeArrayUserError extends teamsfx_api_1.UserError {
    constructor(actionName) {
        super({
            ...
            message: localizeUtils_1.getDefaultString("error.aad.manifest.RequiredResourceAccessShouldBeArray"),
            displayMessage: localizeUtils_1.getLocalizedString("error.aad.manifest.RequiredResourceAccessShouldBeArray"),
            helpLink: "https://aka.ms/teamsfx-aad-manifest",
        });
    }
}
...
class HostNameNotOnVerifiedDomainError extends teamsfx_api_1.UserError {
    constructor(actionName, errorMessage) {
        super({
            ...
            message: localizeUtils_1.getDefaultString("error.aad.manifest.HostNameNotOnVerifiedDomain", errorMessage),
            displayMessage: localizeUtils_1.getLocalizedString("error.aad.manifest.HostNameNotOnVerifiedDomain", errorMessage),
