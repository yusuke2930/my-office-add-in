...
class AadManifestHelper {
    ...
    static validateManifest(manifest) {
        ...
        else if (!((_a = manifest.optionalClaims.accessToken) === null || _a === void 0 ? void 0 : _a.find((item) => item.name === "idtyp"))) {
