...
class AadAppClient {
    constructor(m365TokenProvider, logProvider) {
        ...
        this.axios.interceptors.request.use(async (config) => {
            var _a;
            (_a = this.logProvider) === null || _a === void 0 ? void 0 : _a.debug(localizeUtils_1.getLocalizedString("core.common.SendingApiRequest", config.url, JSON.stringify(config.data)));
        ...
        this.axios.interceptors.response.use((response) => {
            var _a;
            (_a = this.logProvider) === null || _a === void 0 ? void 0 : _a.debug(localizeUtils_1.getLocalizedString("core.common.ReceiveApiResponse", JSON.stringify(response.data)));
            return response;
        });
    ...
    clientSecretDescription = "default") {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(err) && err.response) {
                if (((_b = (_a = err.response.data) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.code) === constants_1.aadErrorCode.credentialInvalidLifetimeAsPerAppPolicy) {
                    throw new credentialInvalidLifetimeError_1.CredentialInvalidLifetimeError(AadAppClient.name);
                }
                if (((_d = (_c = err.response.data) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.code) === constants_1.aadErrorCode.credentialTypeNotAllowedAsPerAppPolicy) {
    ...
    async updateAadApp(manifest) {
        ...
        try {
            ...
            if (axios_1.default.isAxiosError(err) && err.response && err.response.status === 400) {
                if (((_a = err.response.data.error) === null || _a === void 0 ? void 0 : _a.code) === constants_1.aadErrorCode.permissionErrorCode) {
                    throw new aadManifestError_1.DeleteOrUpdatePermissionFailedError(AadAppClient.name);
                }
                if (((_b = err.response.data.error) === null || _b === void 0 ? void 0 : _b.code) === constants_1.aadErrorCode.hostNameNotOnVerifiedDomain) {
