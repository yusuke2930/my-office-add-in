    ...
    async executeInternal(args, context, outputEnvVarNames) {
        ...
        try {
            ...
            if (!aadAppState.clientId) {
                ...
                const aadApp = await aadAppClient.createAadApp(args.name, signInAudience, args.serviceManagementReference);
            ...
            if (args.generateClientSecret) {
                if (!aadAppState.clientSecret) {
                    ...
                    (_j = context.logProvider) === null || _j === void 0 ? void 0 : _j.info(localizeUtils_1.getLocalizedString(constants_1.logMessageKeys.skipCreateAadApp, outputEnvVarNames.get(createAadAppOutput_1.OutputKeys.clientSecret)));
                }
            }
            (_k = context.logProvider) === null || _k === void 0 ? void 0 : _k.info(localizeUtils_1.getLocalizedString(constants_1.logMessageKeys.successExecuteDriver, actionName));
            return {
            ...
            if (error instanceof teamsfx_api_1.UserError || error instanceof teamsfx_api_1.SystemError) {
                (_l = context.logProvider) === null || _l === void 0 ? void 0 : _l.error(localizeUtils_1.getLocalizedString(constants_1.logMessageKeys.failExecuteDriver, actionName, error.displayMessage));
                return {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                (_m = context.logProvider) === null || _m === void 0 ? void 0 : _m.error(localizeUtils_1.getLocalizedString(constants_1.logMessageKeys.failExecuteDriver, actionName, message));
            ...
            (_o = context.logProvider) === null || _o === void 0 ? void 0 : _o.error(localizeUtils_1.getLocalizedString(constants_1.logMessageKeys.failExecuteDriver, actionName, message));
            return {
