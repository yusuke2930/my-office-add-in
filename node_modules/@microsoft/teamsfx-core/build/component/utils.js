...
exports.fetchAndUnzip = exports.sendErrorTelemetryThenReturnError = exports.ensureComponentConnections = exports.createDriverContext = exports.createContextV3 = void 0;
...
async function fetchAndUnzip(component, zipUrl, targetDir, skipRootFolder = true) {
    let zip;
    try {
        zip = await utils_1.fetchZipFromUrl(zipUrl);
    }
    catch (e) {
        return teamsfx_api_1.err(new common_1.AccessGithubError(zipUrl, component, e));
    }
    if (!zip) {
        return teamsfx_api_1.err(new common_1.AccessGithubError(zipUrl, component, new Error(`Failed to fetch zip from url: ${zipUrl}, result is undefined.`)));
    }
    ...
    for (const entry of entries) {
        ...
        const targetPath = path_1.default.join(targetDir, entryName.replace(rootFolderName, ""));
        try {
            ...
            return teamsfx_api_1.err(new common_1.WriteFileError(error, component));
        }
    }
    return teamsfx_api_1.ok(undefined);
}
exports.fetchAndUnzip = fetchAndUnzip;
