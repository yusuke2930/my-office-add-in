        ...
        if (await fs_extra_1.default.pathExists(packageJsonPath)) {
            ...
            if (jsonContentRes.isErr()) {
                ...
                if (!packageJson.engines) {
                    telemetry_helper_1.telemetryHelper.sendErrorEvent(context, telemetryEvents_1.TelemetryEvents.GetSpfxNodeVersionFailed, error_2.CannotFindPropertyfromJsonError("engines"));
                }
                else {
                    if (!packageJson.engines.node) {
                        telemetry_helper_1.telemetryHelper.sendErrorEvent(context, telemetryEvents_1.TelemetryEvents.GetSpfxNodeVersionFailed, error_2.CannotFindPropertyfromJsonError("engines.node"));
                    }
                    else {
...
class SPFxGeneratorNew extends templateGenerator_1.DefaultTemplateGenerator {
    ...
    activate(context, inputs) {
        ...
        const spfxSolution = inputs[questionNames_1.QuestionNames.SPFxSolution];
        return capability === create_1.CapabilityOptions.SPFxTab().id && spfxSolution === "new";
    }
        ...
        return teamsfx_api_1.ok([
            {
                ...
                language: create_1.ProgrammingLanguage.TS,
...
class SPFxGeneratorImport extends templateGenerator_1.DefaultTemplateGenerator {
    ...
    async getTemplateInfos(context, inputs, destinationPath, actionContext) {
        ...
        try {
            ...
            context.templateVariables["webpartName"] =
                webpartManifest["preconfiguredEntries"][0].title.default;
            this.importDetails.push(`(.) Processing: Generating SPFx project templates with app name: ${inputs[questionNames_1.QuestionNames.AppName]}, component id: ${webpartManifest["id"]}, web part name: ${webpartManifest["preconfiguredEntries"][0].title.default}`);
            return teamsfx_api_1.ok([
                {
                    templateName: constants_2.Constants.TEMPLATE_NAME,
                    language: create_1.ProgrammingLanguage.TS,
            ...
            this.importDetails.push(localizeUtils_1.getLocalizedString("plugins.spfx.import.log.fail", (_a = context.logProvider) === null || _a === void 0 ? void 0 : _a.getLogFilePath()));
    ...
    async post(context, inputs, destinationPath, actionContext) {
        ...
        try {
            ...
            this.importDetails.push(localizeUtils_1.getLocalizedString("plugins.spfx.import.log.success", (_a = context.logProvider) === null || _a === void 0 ? void 0 : _a.getLogFilePath()));
            await context.logProvider.logInFile(teamsfx_api_1.LogLevel.Info, this.importDetails.join(os_1.EOL));
            void context.logProvider.info(localizeUtils_1.getLocalizedString("plugins.spfx.import.log.success", (_b = context.logProvider) === null || _b === void 0 ? void 0 : _b.getLogFilePath()));
            void context.userInteraction.showMessage("info", localizeUtils_1.getLocalizedString("plugins.spfx.import.success", destinationPath), false);
            return teamsfx_api_1.ok(undefined);
        }
        catch (error) {
            this.importDetails.push(localizeUtils_1.getLocalizedString("plugins.spfx.import.log.fail", (_c = context.logProvider) === null || _c === void 0 ? void 0 : _c.getLogFilePath()));
            await context.logProvider.logInFile(teamsfx_api_1.LogLevel.Info, this.importDetails.join(os_1.EOL));
            void context.logProvider.error(localizeUtils_1.getLocalizedString("plugins.spfx.import.log.fail", (_d = context.logProvider) === null || _d === void 0 ? void 0 : _d.getLogFilePath()));
            if (error instanceof teamsfx_api_1.UserError || error instanceof teamsfx_api_1.SystemError) {
                return teamsfx_api_1.err(error);
            }
            return teamsfx_api_1.err(error_2.ImportSPFxSolutionError(error));
