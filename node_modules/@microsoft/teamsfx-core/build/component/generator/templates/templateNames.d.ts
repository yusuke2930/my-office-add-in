...
export declare const Feature2TemplateName: {
    [x: string]: TemplateNames;
};
export declare function tryGetTemplateName(inputs: Inputs): TemplateNames | undefined;
export declare function getTemplateName(inputs: Inputs): TemplateNames;
export declare const inputsToTemplateName: Map<{
    [key: string]: any;
}, TemplateNames>;
