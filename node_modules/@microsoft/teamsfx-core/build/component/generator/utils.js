...
async function getTemplateLatestTag(name, tryLimits = constant_1.defaultTryLimits, timeoutInMs = constant_1.defaultTimeoutInMs) {
...
exports.getTemplateLatestTag = getTemplateLatestTag;
function getTemplateZipUrlByTag(name, selectedTag) {
    return `${templates_config_json_1.default.templateDownloadBaseURL}/${selectedTag}/${name}.zip`;
}
exports.getTemplateZipUrlByTag = getTemplateZipUrlByTag;
...
async function getSampleInfoFromName(sampleName) {
    ...
    if (!sample) {
        throw error_1.InvalidInputError(`sample '${sampleName}' not found`);
    }
    return sample;
}
...
function convertToLangKey(programmingLanguage) {
    switch (programmingLanguage) {
        ...
        case question_1.ProgrammingLanguage.PY: {
            return "python";
        }
    }
