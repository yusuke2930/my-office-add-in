...
export declare function getTemplateLatestTag(name: string, tryLimits?: number, timeoutInMs?: number): Promise<string>;
export declare function getTemplateZipUrlByTag(name: string, selectedTag: string): string;
