...
exports.extractMethodNamesFromErrorStack = exports.fillinProjectTypeProperties = exports.fillInTelemetryPropsForFxError = exports.sendTelemetryErrorEvent = exports.sendTelemetryEvent = exports.ProjectMigratorGuideStatus = exports.WebApplicationIdValue = exports.ProjectMigratorStatus = exports.CustomizeSubscriptionType = exports.CustomizeResourceGroupType = exports.Component = exports.TelemetryErrorType = exports.TelemetrySuccess = exports.ProjectTypeProps = exports.TelemetryEvent = exports.TelemetryProperty = void 0;
...
function fillInTelemetryPropsForFxError(props, error) {
    ...
    props[constants_1.TelemetryConstants.properties.errorMessage] = error.skipProcessInTelemetry
        ? error.message
        : stringUtils_1.maskSecret(error.message);
    props[constants_1.TelemetryConstants.properties.errorStack] = extractMethodNamesFromErrorStack(error.stack); // error stack will not append in error-message any more
...
function fillinProjectTypeProperties(props, projectTypeRes) {
    var _a;
    const newProps = {
    ...
    lodash_1.assign(props, newProps);
}
exports.fillinProjectTypeProperties = fillinProjectTypeProperties;
function extractMethodNamesFromErrorStack(stack) {
    if (!stack)
        return "";
...
exports.extractMethodNamesFromErrorStack = extractMethodNamesFromErrorStack;
