...
class VxTestAppChecker {
    ...
    async installVersion(version, installDir) {
        ...
        await downloadHelper_1.downloadToTempFile(downloadUrl, { timeout: VxTestAppDownloadTimeoutMillis }, async (zipFilePath) => {
            await downloadHelper_1.unzip(zipFilePath, installDir);
        });
    }
