import { ApiOperation, CoreCallbackEvent, CreateProjectInputs, CreateProjectResult, CryptoProvider, Func, FxError, IGenerator, IQTreeNode, Inputs, InputsWithProjectPath, OpenAIPluginManifest, Result, Stage, TeamsAppInputs, Tools } from "@microsoft/teamsfx-api";
...
export declare class FxCore {
     ...
     * Add plugin
     */
    addPlugin(inputs: Inputs): Promise<Result<undefined, FxError>>;
}
